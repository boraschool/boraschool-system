        ...
        >
          ...
          <form className="space-y-8" onSubmit={handleLogin}>
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="block text-sm font-medium text-[#5A5A40] ml-1">
                Teacher Email
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. mwalimu@boraschool.com"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between px-1">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-[#5A5A40] hover:underline underline-offset-4">
                  Forgot password?
                </a>
              </div>
            </div>
